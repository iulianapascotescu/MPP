...
public class RentController {
    ...
    public RentDto saveRent(@RequestBody NewRentDto newRentDto) {
        log.trace("RentsDto saveRent: - method entered");
        log.trace("{}, {}", newRentDto.getMovieTitle(), newRentDto.getClientName());
